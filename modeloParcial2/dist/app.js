...
(function (Entidades) {
    var App = /** @class */ (function () {
        ...
        App.CargarFormulario = function (id) {
            for (var i = 0; i < this.listaMascotas.length; i++) {
                ...
                if (mascota.id == id) {
                    ...
                    $("#edad").val(mascota.getEdad());
                    $("#sexo").val(mascota.getSexo());
                    break;
                }
            }
        };
        ...
        App.obtenerSiguienteId = function () {
            var id = localStorage.getItem("secuencia_id");
            localStorage.setItem("secuencia_id", id++);
            return id;
        };
        ...
        App.Alta = function () {
            ...
            var mascota = new Entidades.Mascota(this.obtenerSiguienteId(), nombre, edad, sexo);
        ...
        App.crearTabla = function (arrayMascotas) {
            ...
            arrayMascotas.forEach(function (mascota) {
                ...
                if (mostrarEdad) {
                    html += "<td>" + mascota.getEdad() + "</td>";
                }
                if (mostrarSexo) {
                    html += "<td>" + mascota.getSexo() + "</td>";
                }
                html += "</tr>";
            });
            html += "</tbody>";
